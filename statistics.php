...
$GLOBALS['one']=$v['all_cases'];
 ...
 $GLOBALS['three']=$v['recovery_cases'];
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" readonly value='<?php echo $GLOBALS["one"]; ?>'/>
    </div>
  </div>
         <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">اجمالي عدد الوفيات</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" readonly value='<?php echo $GLOBALS["two"]; ?>'/>
    </div>
  </div>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">عدد حالات الشفاء</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" readonly value='<?php echo $GLOBALS["three"]; ?>'/>
    </div>
  </div>
            </div>
      </div>
