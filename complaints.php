...
<html>
<head>
   <title>الشكاوي والمقتراحات</title>
    <meta charset="utf-8"/>
...
<div class="container">
  ...
  <div class="card-header">
    قم بكتابة الشكوي او الاقتراح في الصندوق التالي:
  </div>
<div class="form-group">
    <form>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" autofocus></textarea>
