...
<html>
<head>
   <title>البحث بواسطة رقم الهاتف</title>
    <meta charset="utf-8"/>
<meta name="description" content="tanta"/>
  ...
  <img src="images/title.jpg" width="60" height="60" alt="" loading="lazy"/>
       ...
       <form action="s_phone_p.php" method="post">
       <div class="card">
...
اخل رقم الهاتف
  ...
  <div class="card-body">
    ...
    <div class="col-sm-10">
      <input type="search" class="form-control" id="inputEmail3" autofocus autocomplete="off" name="phone"/>
