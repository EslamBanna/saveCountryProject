...
<meta name="description" content="tanta"/>
  ...
  <img src="images/title.jpg" width="60" height="60" alt="" loading="lazy"/>
         ...
         <form action="create_a_p.php" method="post">
       <div class="card x">
  <div class="card-header">
    البيانات الخاصة بالأدمن
  </div>
  <div class="card-body">
    <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">اسم الأدمن</label>
    <div class="col-sm-10">
    ...
    <div class="col-sm-10">
      ...
      <button type="submit" class="btn btn-secondary">انشاء</button>
