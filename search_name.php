...
<html>
<head>
   <title>البحث بواسطة اٍلأسم</title>
    <meta charset="utf-8"/>
<meta name="description" content="tanta"/>
  ...
  <img src="images/title.jpg" width="60" height="60" alt="" loading="lazy"/>
       ...
       <form action="s_name_p.php" method="post"> 
       <div class="card">
...
اخل اسم العضو 
  ...
  <div class="card-body">
    ...
    <div class="col-sm-10">
      <input type="search" class="form-control" id="inputEmail3" autofocus autocomplete="off" name="s_name"/>
