...
<html>
<head>
   <title> تسجيل الدخول صلاحية الدكتور</title>
    <meta charset="utf-8"/>
...
<form action="process2.php" method="post">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" autofocus autocomplete="off" name="phone"/>
    </div>
  </div>
    <div class="form-group row">
...
<p>اذا كانت هذة أول زيارة لك في المنصة وليس لديك حساب عليها اضغط علي الزر التالي...</p>
              <div class="end"> <button type="button" class="btn btn-success"><a href="create_c.php" class="return">انشاء حساب جديد</a></button></div>
  </div>
</div>
